                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e('The <address@mydomain.com> part of the sender information ("Excited User <user@samples.mailgun.org>"). This address will appear as the `From` address on sent mail. It is recommended that the @mydomain portion matches your WordPress domain.', 'mailgun'); ?></p>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e('The "User Name" part of the sender information ("Excited User <user@samples.mailgun.org>").', 'mailgun'); ?></p>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">
